...
const Payments = () => {
  ...
  const fetchPayments = async () => {
    try {
      const response = await api.get(`/admin/payments?page=${currentPage}&limit=10`);
      ...
      {payments.length === 0 ? (
        <Card>
          <EmptyState
            ...
            description="No payment transactions available"
          />
        </Card>
      ) : (
        <>
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <span className="ml-2 font-medium">{payment.billing?.billId}</span>
                      </div>
                    </div>
